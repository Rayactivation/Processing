...
void setup()
{
  ...
  opc1 = new OPC(this, "10.0.0.35", 7890);
  ...
  opc1.ledStrip(0, 32, width/2, 0 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
  opc1.ledStrip(1, 32, width/2, 1 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
  opc1.ledStrip(4, 32, width/2, 2 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
  opc1.ledStrip(5, 32, width/2, 3 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
  opc1.ledStrip(8, 32, width/2, 4 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
  opc1.ledStrip(9, 32, width/2, 5 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
  opc1.ledStrip(12, 32, width/2, 6 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
  opc1.ledStrip(13, 32, width/2, 7 * height/vertSpacing + vertOffSet, width / 70.0, 0, false);
